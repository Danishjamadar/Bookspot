...
<body>
  ...
  <tr>
    <th style="background-color: #f2f2f2; padding: 10px;">Faculty ID</th>
    <th style="background-color: #f2f2f2; padding: 10px;">Faculty Name</th>
	...
	if ($query->rowCount() > 0) {
		foreach ($results as $result) {
			$table .= '<tr>
				...
				<td><center>' . date('Y-m-d', strtotime($result->ReturnDate)) . '</center></td>
			</tr>';
		}
	}
	$table .= '
