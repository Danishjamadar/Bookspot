                            ...
                            <form role="form" method="post" name="chngpwd" onSubmit="return valid();">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="studentid" id="studentid"
                                        value="<?php echo htmlentities($stdid); ?>" onBlur="getstudent()" required />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="booikid" id="bookid"
                                        value="<?php echo htmlentities($bookid); ?>" onBlur="getbook()"
                                        required="required" />
                                </div>
                                <div class="form-group">
                                    Book Title<select class="form-control" name="bookdetails" id="get_book_name"
                                        readonly>
                                    </select>
                                </div>
