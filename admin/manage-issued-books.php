...
<head>
    ...
    <title>Manage Issued Books - Students</title>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                                <?php echo date('d-m-Y', strtotime($result->IssuesDate)); ?>
                                            </td>
                                            <td class="center"><?php if ($result->ReturnDate == "") {
                                                            $date = Date('d/m/Y');
                                                            $date2 = Date("d/m/Y", strtotime($result->IssuesDate));
                                            ...
                                            <td class="center">
                                                ...
                                                <a
                                                    href="update-issue-bookdeails.php?rid=<?php echo htmlentities($result->rid); ?>&ISBNNumber=<?php echo htmlentities($result->ISBNNumber); ?>&status=<?php echo htmlentities($str); ?>&days=<?php echo htmlentities($days); ?>"><button
