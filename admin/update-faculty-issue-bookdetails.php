...
<head>
    ...
    <title>Faculty Issued Book </title>
                            ...
                            <div class="form-group">
                                <?php
                                        ...
                                        if (strpos($status, 'exceeded') !== false && $result->ReturnDate === NULL) {
                                            ...
                                            ?>
                                <span><b>Fine To Be
                                        Paid:</b><?php echo htmlentities($days * $_SESSION['fine']); ?></span>
                                <?php
                                        } ?>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-8" style="padding-left:20px;padding-top:-20px;">
                                        <button type="submit" name="return" id="submit" class="btn btn-info">Return
                                            Book</button>
                                    </div>
                                </div>
                            </div>
