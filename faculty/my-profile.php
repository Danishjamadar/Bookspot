...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = "update tblfaculties set FullName=:fname,MobileNumber=:mobileno where StudentId=:sid";
                    ...
                    <div class="panel panel-danger">
                        ...
                        <div class="panel-body">
                            <form name="signup" method="post">
                                <?php
                                    $sid = $_SESSION['stdid'];
                                    $sql = "SELECT StudentId,FullName,EmailId,MobileNumber,Status from  tblfaculties  where StudentId=:sid ";
                                    $query = $dbh->prepare($sql);
                                    $query->bindParam(':sid', $sid, PDO::PARAM_STR);
                                    $query->execute();
