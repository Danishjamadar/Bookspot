...
if (isset($_POST['signup'])) {
    ...
    $status = 1;
    $sql = "INSERT INTO  tblfaculties(StudentId,FullName,MobileNumber,EmailId,Password,Status) VALUES(:StudentId,:fname,:mobileno,:email,:password,:status)";
    ...
    if ($lastInsertId) {
        echo '<script>alert("Your Registration successfull and your Faculty id is  "+"' . $StudentId . '")</script>';
    } else {
...
<head>
    ...
    <title>Bookspot: Faculty Signup</title>
